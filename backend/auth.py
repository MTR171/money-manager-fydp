...
# ── Configuration ─────────────────────────────────────────────────────────────
SECRET_KEY = os.getenv("SECRET_KEY", "money-manager-super-secret-key-fydp-2026-stable")
ALGORITHM = "HS256"
...
def get_current_user(
    ...
    from models import User  # local import to avoid circular dependency at module load time
